...
ActiveRecord::Schema[7.1].define(version: 2026_09_14_012159) do
  ...
  create_table "course_materials", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "course_id", null: false
    t.bigint "material_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["course_id", "material_id"], name: "index_course_materials_on_course_id_and_material_id", unique: true
    t.index ["course_id"], name: "index_course_materials_on_course_id"
    t.index ["material_id"], name: "index_course_materials_on_material_id"
  end
  ...
  create_table "subjects", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["sort_order"], name: "index_subjects_on_sort_order", unique: true
  end
